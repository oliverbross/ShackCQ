...
public:
    ...
    QVariantMap page(const WavelogBinding&,const QString&,int page)override{pageCalls++;const QVariantList defaults{QVariantMap{{"id","99"},{"CALL","VK9XX"},{"FREQ","145.800"},{"BAND","2m"},{"MODE","FM"},{"SAT_NAME","QO-100"},{"SAT_MODE","S"},{"PROP_MODE","FUTURE"},{"ANT_PATH","G"},{"TX_PWR","5.5"},{"MY_ANTENNA","Portable whip"},{"POTA_REF","VK-0001,VK-0002"},{"SOTA_REF","VK1/AC-001,VK2/SM-002"},{"WWFF_REF","VKFF-0001,VKFF-0002"},{"IOTA","OC-001,OC-002"},{"QSL_VIA","VK1QSL"},{"QSLMSG","Thanks"},{"QSL_SENT","Y"},{"QSL_RCVD","Y"},{"QSLSDATE","20260911"},{"QSLRDATE","20260912"},{"QSL_SENT_VIA","E"},{"QSL_RCVD_VIA","D"},{"APP_FUTURE","keep"}}};return{{"ok",true},{"data",page==1?(rowsOverride.isEmpty()?defaults:rowsOverride):QVariantList{}},{"meta",QVariantMap{{"has_more",false}}}};}
